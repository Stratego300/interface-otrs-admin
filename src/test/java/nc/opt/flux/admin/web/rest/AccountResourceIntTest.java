package nc.opt.flux.admin.web.rest;

import nc.opt.flux.admin.IoaApp;
import nc.opt.flux.admin.config.JHipsterProperties;
import nc.opt.flux.admin.domain.Authority;
import nc.opt.flux.admin.domain.User;
import nc.opt.flux.admin.repository.AuthorityRepository;
import nc.opt.flux.admin.repository.UserRepository;
import nc.opt.flux.admin.security.AuthoritiesConstants;
import nc.opt.flux.admin.service.MailService;
import nc.opt.flux.admin.service.UserService;
import nc.opt.flux.admin.service.dto.UserDTO;
import nc.opt.flux.admin.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = IoaApp.class)

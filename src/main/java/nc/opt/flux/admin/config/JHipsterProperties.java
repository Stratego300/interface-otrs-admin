package nc.opt.flux.admin.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ioa@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ioa API";

        private String description = "ioa API documentation";
